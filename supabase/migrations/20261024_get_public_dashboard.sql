-- NO-GROUPS VERSION: Updated get_public_dashboard RPC (20261024 migration)
-- Removes all groups references, matches 20261204 simplified schema
...
COMMENT ON FUNCTION get_public_dashboard() IS 'Public dashboard aggregates for church stats (NO GROUPS VERSION)';
